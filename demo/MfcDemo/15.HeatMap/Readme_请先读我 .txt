【Demo功能】
1、Demo介绍SDK初始化、登陆设备、登出设备、实时监视，查询热度图，显示热度图功能。

【注意事项】
1、编译环境为VS2005。
2、此Demo只演示查询热度图功能，如用户有需求请自行修改。
...
【Demo Features】
1.Demo SDK initialization,login device,logout device,realplay, heatmap query function.

【NOTE】
1.Complier for Demo is VS2005.
2.Just only support for Heatmap query, realplay function.Modify the code if the user has a requirement.
